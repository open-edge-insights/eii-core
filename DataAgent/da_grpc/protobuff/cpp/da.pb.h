...
template<> ::DataAgent::ConfigIntReq* Arena::CreateMaybeMessage<::DataAgent::ConfigIntReq>(Arena*);
template<> ::DataAgent::ConfigIntResp* Arena::CreateMaybeMessage<::DataAgent::ConfigIntResp>(Arena*);
...
class ConfigIntReq : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:DataAgent.ConfigIntReq) */ {
 public:
  ...
  inline ConfigIntReq* New() const final {
    return CreateMaybeMessage<ConfigIntReq>(NULL);
  }

  ConfigIntReq* New(::google::protobuf::Arena* arena) const final {
    return CreateMaybeMessage<ConfigIntReq>(arena);
  }
  void CopyFrom(const ::google::protobuf::Message& from) final;
  void MergeFrom(const ::google::protobuf::Message& from) final;
...
class ConfigIntResp : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:DataAgent.ConfigIntResp) */ {
 public:
  ...
  inline ConfigIntResp* New() const final {
    return CreateMaybeMessage<ConfigIntResp>(NULL);
  }

  ConfigIntResp* New(::google::protobuf::Arena* arena) const final {
    return CreateMaybeMessage<ConfigIntResp>(arena);
  }
  void CopyFrom(const ::google::protobuf::Message& from) final;
  void MergeFrom(const ::google::protobuf::Message& from) final;
